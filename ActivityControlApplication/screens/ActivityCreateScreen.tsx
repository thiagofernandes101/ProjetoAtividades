...
export default function CreateScreen({ navigation }: RootTabScreenProps<'Activity'>) {
    ...
    async function salvaDados() {
        let activityModel: ActivityModel = new ActivityModel(0, descricao, tipoAtividade, local, data, hora, parseInt(statusAtividade))
        try {
            console.log(activityModel);
            await ActivityDatabaseService.insertActivity(activityModel);
